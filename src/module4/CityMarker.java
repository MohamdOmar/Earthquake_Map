...
public class CityMarker extends SimplePointMarker {
	...
	public void draw(PGraphics pg, float x, float y) {
		...
		pg.fill(139, 69, 19);  // RGB for brown
		pg.triangle(x-TRI_SIZE, y+TRI_SIZE, x, y-TRI_SIZE, x+TRI_SIZE, y+TRI_SIZE);
		
		// Optionally, you can add the city name as text above the triangle
	    //pg.fill(0); // Black color for text
	    //pg.textAlign(pg.CENTER, pg.BOTTOM); // Centered and bottom-aligned text
	    //pg.text(getCity(), x, y - TRI_SIZE - 2); // Display city name above the triangle
